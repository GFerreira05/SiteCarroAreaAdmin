...
if (isset($_GET["id"])) {
    ...
    $sql_delete = "DELETE FROM llogin WHERE id_login = ?";
    ...
    if ($stmt_delete->execute() === TRUE) {
        ...
        echo "Erro ao excluir login: " . $con->error;
    }
}
...
$where = "";
        ...
        if (isset($_GET["localizar"])) {
            ...
            if (!empty($localizar)) {
                $where = " WHERE nome LIKE '%$localizar%' OR sobrenome LIKE '%$localizar%' OR email LIKE '%$localizar%' OR senha LIKE '%$localizar%' OR adm LIKE '%$localizar%'";
            }
        }
    
        $sql = "SELECT * FROM llogin $where";
        $rs = $con->query($sql);
...
?>
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Adicionar Novo Usuário</h6>
    </div>
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form method="post" action="banco_cadastro_usuario.php" class="user">
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="text" class="form-control form-control-user py-4" name="nome" placeholder="Nome" required>
                        </div>
                        <div class="col-sm-6">
                            <input type="text" class="form-control form-control-user py-4" name="sobrenome" placeholder="Sobrenome" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <input type="email" class="form-control form-control-user py-4" name="email" placeholder="Email" required>
                        </div>
                        <div class="col-sm-6">
                            <input type="password" class="form-control form-control-user py-4" name="senha" placeholder="Senha" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="adm" name="adm" value="1">
