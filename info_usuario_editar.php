...
<body id="page-top">
    ...
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-8">
            <form method="post" action="banco_editar_usuario.php" class="user">
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <input class="d-none" id="idlogin" type="text" class="form-control form-control-user py-4" value="<?php echo ($_GET["id"]) ?>" name="idlogin" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
